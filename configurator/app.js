...
function emitReadme() {
  ...
  return [
    ...
    s.webapp && s.arch === "aarch64"
      ? "2. Extract the whole bundle into a folder, keeping the `webapp/` subfolder (it patches the ARM-incompatible Fika Web App image at first build — nothing is downloaded from a third party)."
